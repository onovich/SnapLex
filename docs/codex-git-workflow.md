...
Project: SnapLex
Repository root: D:/ToolProjects/SnapLex
Machine config: `
...
```
powershell
git -c safe.directory=D:/ToolProjects/SnapLex status --short --branch
```
...
```
powershell
git -c safe.directory=D:/ToolProjects/SnapLex push -u origin HEAD
```
